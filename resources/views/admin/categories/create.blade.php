...
<x-app-layout>
    <x-slot:header>
        <div class="w-full flex items-center justify-between">
            ...
            <a href="{{ route('categories.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">{{ __('К списку заявок') }}</a>
        </div>
        </x-slot>
